...
class LearnTest(unittest.TestCase):
    ...
    def test_momentumWrapper2(self):
        ...
        rnnWrapper3Clone.create_rnn(False)
        rnnWrapper3.model.updateClone(rnnWrapper3Clone.model)
        # rnnWrapper3Clone.model = rnnWrapper3.model.clone(isDropoutEnabled=False)  # seems to be bad?
        ...
        # rnnWrapper3.modelEvaluator = rnn_model.FlatTrainer.ModelEvaluator(model=rnnWrapper3.model, trainParam=rnnWrapper3.trainParam)
